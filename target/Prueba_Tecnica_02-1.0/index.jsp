                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="display: flex; width: 230px">
                                <form name="eliminar" action="EliminarCiudadanoSv" method="POST" onsubmit="return confirm('¿Estás seguro de eliminar a este ciudadano?');"> <!-- manda el código al servlet -->
