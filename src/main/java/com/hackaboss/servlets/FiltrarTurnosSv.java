...
public class FiltrarTurnosSv extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("turnos", control.listarTurnosPorEstado(estado)); // Filtra por estado
        RequestDispatcher rd = request.getRequestDispatcher("turnosFiltrados.jsp");
