...
public class ControladoraLogica {
    ...
    public void eliminarCiudadano(Long id) { controlPersis.eliminarCiudadano(id); }

    public Ciudadano buscarCiudadano(Long id) { return controlPersis.traerCiudadano(id); }

    public void editarCiudadano(Ciudadano ciud) { controlPersis.editarPersona(ciud); }

    public List<Ciudadano> traerCiudadanos() { return controlPersis.traerCiudadanos(); }

    public List<TipoTramite> traerTramites() { return controlPersis.traerTramites(); }

    public int contarTurnosPorFecha(Date fechaTurno) { return controlPersis.contarTurnosPorFecha(fechaTurno); }
    ...
    public List<Turno> traerTurnos() { return controlPersis.traerTurnos(); }

    public List<Turno> filtrarTurnosPorFecha(Date fechaTurno) { return controlPersis.filtrarTurnosPorFecha(fechaTurno); }

    public List<Turno> filtrarTurnosPorEstado(String estadoTurno) { return controlPersis.filtrarTurnosPorEstado(estadoTurno); }
